       ...
       ?>
        @endif
            ...
            <div class="col-md-4">
                    ...
                    <input type="text" value="{{$total2}}" id="subtotal"  class="form-control mt-1" readonly="" style="width: 120px">           
                </div>
                
                <div class="col-md-4">
                    <label for=""><h4>Subtotal:</h4></label>
                    <input type="text" id="sum" name="sumtotal"  class="form-control mt-1" readonly="" style="width: 120px" required="">      
                </div>
                <div class="col-md-4">

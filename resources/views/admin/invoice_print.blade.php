                                        ...
                                        <div class="mt-md-0 mt-2">
                                            ...
                                            <div class="invoice-date-wrapper">
                                              @foreach($client_info as $inv_date)
                                                ...
                                                <span style="color: black;" class="invoice-date">{{date('Y-m-d',strtotime($inv_date->created_at))}}</span>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div id="invoice-total-wrapper" class="invoice-total-wrapper">
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Subtotal: <span style="color: black;" class="invoice-total-amount">{{$Subtotal}}</span></p>
                                                    
                                                </div>
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Discount: <span style="color: black;" class="invoice-total-amount">{{$inv->discount}}%</span></p>
                                                    
                                                </div>
                                                <hr class="my-2" />
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Subtotal Less Discount:
                                                    <span style="color: black;" class="invoice-total-amount">{{$final}}</sapn></p>

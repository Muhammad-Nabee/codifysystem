...
<head>
    ...
    <meta name="description" content="Codify admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Codify admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Login Page - Codify - Bootstrap HTML admin template</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <!-- <a href="javascript:void(0);" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ml-1">Codify</h2>
                                    
                                </a> -->
                                <a class="brand-logo" href="https://codify.pk/" target="_blank">
                                    <img style="margin-left: 115px!important;" class="brand-text text-primary ml-1" src="{{ asset('public/app-assets/images/logo/codify.png') }}" alt="tag" width="180">
                                </a>
                                <h4 class="card-title mb-1">Welcome to Codify!</h4>
                                @if(session('error'))
                                ...
                                @endif
                                <form class="auth-login-form mt-2" action="check_login" method="POST">
                                @csrf
                                    ...
                                    <!-- <a href="{{route('show_registration_form')}}" class="btn btn-primary">Sign Up</a> -->
                                </form>
                            </div>
                        </div>
                        <!-- /Login v1 -->
